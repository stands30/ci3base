...
define('PROFILE_NO_IMG_PATH', 'assets/images/profile_no_img.png');
...
define('UI_IMAGE_PATH','assets/logo_image/');
define('NO_IMAGE', 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image');
define('BLOCKUSERLISTURL', 'user_dashboard');

define('PERSON_TITLE', 'person_title');
...
/******************* Delegate  *********************/
define('DELEGATE_GEN_PRM','delegate_category');
define('DELEGATE_QR_CODE_PATH','assets/qrcode/delegate/');
/******************* Delegate  *********************/


/*genprm group*/
define('GNP_ACTIVE_STATUS','1');
/*end genprm group*/
