var TableDatatablesRowreorder = function () {
    ...
    var initTable1 = function () {
        ...
        var oTable = table.dataTable({
            ...
            "lengthMenu": [
                [25, 50, 75, 100, -1],
                [25, 50, 75, 20, "All"] // change per page values here
            ],
 ...
 var e=$("#sample_4");
        e.dataTable( {
            ...
            , order:[[0, "asc"]], lengthMenu:[[25, 50, 75, 100, -1], [25, 50, 75, 100, "All"]], pageLength:50, dom:"<'row' <'col-md-12'B>><'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r><'table-scrollable't><'row'<'col-md-5 col-sm-12'i><'col-md-7 col-sm-12'p>>"
        }
        )
